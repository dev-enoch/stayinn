                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                          <span className="font-bold text-slate-900 truncate max-w-[150px] sm:max-w-[200px]">
                            {booking.hotel?.name || "Monarch Stay Property"}
                          </span>
          ...
          <div className="flex items-center justify-between px-6 py-4 border-t border-slate-100 bg-slate-50">
            ...
            <div className="flex gap-2">
              {page > 1 ? (
                ...
                <button
                  disabled
                  className="px-4 py-2 rounded-lg bg-slate-100 border border-slate-200 text-slate-400 text-xs font-bold cursor-not-allowed"
                >
                  Previous
                </button>
              )}
