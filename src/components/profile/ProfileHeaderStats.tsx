      ...
      <div className="flex flex-col md:flex-row md:items-center gap-6">
        ...
        <div className="flex items-center gap-5">
          ...
          <div className="flex flex-col">
            <h2 className="text-2xl font-semibold tracking-tight text-slate-900">{profileName}</h2>
        ...
        <div className="flex items-center gap-8 mt-4 md:mt-0 px-2 md:px-0">
          <div className="flex flex-col">
            <span className="text-2xl font-semibold tracking-tight text-slate-900">{stays}</span>
            <span className="text-xs font-medium text-slate-500 mt-0.5">Stays</span>
          </div>
          <div className="flex flex-col">
            <span className="text-2xl font-semibold tracking-tight text-slate-900">{reviews}</span>
            <span className="text-xs font-medium text-slate-500 mt-0.5">Reviews</span>
          </div>
          <div className="flex flex-col">
            <div className="flex items-center gap-1">
              <span className="text-2xl font-semibold tracking-tight text-slate-900">{rating}</span>
              <Star size={16} className="fill-slate-900 text-slate-900 mb-1" />
            </div>
            <span className="text-xs font-medium text-slate-500 mt-0.5">Rating</span>
          </div>
        </div>
  ...
  return (
    <section className="px-4 py-8 animate-pulse">
      <div className="flex flex-col md:flex-row md:items-center gap-6">
        ...
        <div className="hidden md:block w-px h-16 bg-slate-200 mx-4"></div>
        <div className="flex items-center gap-8 mt-4 md:mt-0 px-2 md:px-0">
          <div className="flex flex-col gap-2"><div className="h-8 w-8 bg-slate-200 rounded"/><div className="h-3 w-10 bg-slate-200 rounded"/></div>
          <div className="flex flex-col gap-2"><div className="h-8 w-8 bg-slate-200 rounded"/><div className="h-3 w-12 bg-slate-200 rounded"/></div>
          <div className="flex flex-col gap-2"><div className="h-8 w-12 bg-slate-200 rounded"/><div className="h-3 w-10 bg-slate-200 rounded"/></div>
        </div>
      </div>
    </section>
  );
