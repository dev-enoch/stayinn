      ...
      >
        ...
        <div className="px-5 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">Manage your account protection</p>
          </div>
          <button 
            onClick={onClose}
        ...
        <form onSubmit={handleSave} className="p-5 flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-3 p-4 rounded-xl border border-teal-100 bg-teal-50">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-teal-900 text-sm">Two-Factor Authentication</span>
            </div>
            <p className="text-xs text-teal-800/80 leading-relaxed">
              Enhance your account security by requiring an SMS or authenticator code when logging in from new devices.
            </p>
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-bold text-slate-500 uppercase tracking-wider">Update Password</label>
            <button 
              type="button" 
            ...
            <p className="text-[10px] text-slate-400 mt-1">We'll send a secure link to your registered email</p>
          </div>
