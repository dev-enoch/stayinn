        ...
        <form onSubmit={handleSave} className="p-6 flex flex-col gap-6">
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex gap-2">
                <button
                  type="button"
                  className="px-4 py-1.5 text-xs font-semibold rounded-lg bg-white border border-slate-200 text-slate-700 hover:bg-slate-50"
                >
                  Change Photo
                </button>
                <button
                  type="button"
                  className="px-4 py-1.5 text-xs font-semibold rounded-lg text-red-600 hover:bg-red-50"
                >
                  Remove
                </button>
              </div>
          ...
          <div className="bg-slate-50 rounded-lg p-3 flex items-start gap-3 border border-slate-100 mt-2">
            ...
            <p className="text-xs text-slate-600 leading-relaxed">
              Profile updates automatically sync with our partnered estate
              security protocols for seamless gate clearance.
            </p>
          </div>
