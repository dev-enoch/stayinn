  ...
  return (
    ...
    >
      ...
      <div className="md:col-span-2">
        <button
          type="submit"
          className="w-full h-[52px] rounded-xl bg-orange-700 hover:bg-orange-800 text-white text-sm font-bold flex items-center justify-center gap-2 shadow-md transition-all"
        >
          <Search size={18} />
          <span>Search</span>
        </button>
