    ...
    <footer className="bg-slate-900 text-slate-300 w-full pt-20 pb-12 transition-colors border-t border-slate-800">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-12 px-4 md:px-12 max-w-[1440px] mx-auto mb-16">
        ...
        <div className="md:col-span-4 space-y-6">
          ...
          <p className="text-slate-400 text-sm leading-relaxed max-w-sm">
            Experience curated architectural spaces, uncompromised comfort, and
            the warmth of Nigerian hospitality. The premium standard for
            extended stays.
          </p>
          <div className="flex items-center gap-4 pt-2">
            <a
              href="https://instagram.com/monarchstay.ng"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Instagram"
              className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-orange-600 hover:text-white transition-colors"
            >
              <svg
            ...
            <a
              href="https://x.com/monarchstay_ng"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="X (Twitter)"
              className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-black hover:text-white transition-colors"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
            ...
            <a
              href="https://linkedin.com/company/monarchstay-ng"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="LinkedIn"
              className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-teal-900 hover:text-white transition-colors"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
        ...
        <div className="md:col-span-2 md:col-start-6 space-y-5">
          <h4 className="font-semibold text-sm tracking-wider text-white uppercase">
            Company
          </h4>
        ...
        <div className="md:col-span-3 space-y-5">
          ...
          <ul className="space-y-4">
            ...
            <li className="text-slate-400 text-sm flex items-center gap-3">
              ...
              <span>concierge@monarchstay.ng</span>
            </li>
            <li className="text-slate-400 text-sm flex items-center gap-3">
      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-12">
        <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row items-center justify-between gap-4 text-xs font-medium text-slate-500">
          <p>
            © {new Date().getFullYear()} Monarch Stay Technologies. All rights
            reserved. RC 1948291.
          </p>
