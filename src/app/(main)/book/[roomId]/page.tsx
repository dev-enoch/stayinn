    ...
    <div className="flex flex-col w-full bg-slate-50 min-h-screen pt-20">
      <div className="max-w-[1280px] w-full mx-auto px-4 md:px-12 py-12">
        ...
        <nav
          ...
          className="flex items-center gap-2 mb-10 text-slate-500 text-sm font-semibold"
        >
          <Link
            href="/explore"
          ...
          <span className="hover:text-teal-900 transition-colors cursor-pointer">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col gap-12">
            ...
            <div className="flex flex-col gap-2">
              ...
              <h1 className="font-serif text-4xl text-teal-950 tracking-tight font-bold">
                Review & Secure Your Stay
              </h1>
              <p className="text-slate-600 leading-relaxed">
                Review your travel dates, concierge selections, and finalize
                your secure Nigerian escrow payment.
              </p>
            </div>
            ...
            <section className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 flex flex-col gap-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <span className="w-8 h-8 rounded-lg bg-teal-900 text-white flex items-center justify-center font-bold text-sm">
                    1
                  </span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2 flex flex-col gap-2">
                  <label className="text-[10px] uppercase tracking-wider text-slate-500 font-bold">
                    WhatsApp / SMS Contact (For Host & Gate Coordinator)
                  </label>
                  <div className="p-3.5 bg-slate-50 rounded-xl text-sm text-slate-900 font-semibold flex items-center justify-between border border-slate-100">
              ...
              <div className="p-5 rounded-2xl bg-slate-50 border border-slate-100 flex flex-col gap-4 mt-2">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      <h3 className="text-base text-slate-900 font-bold">
                        Ikoyi Estate Gate Pre-Clearance
                      </h3>
                      <span className="px-2 py-0.5 rounded text-[10px] bg-orange-100 text-orange-800 uppercase font-bold">
                        Fast-Track
                      </span>
                    </div>
                    <p className="text-sm text-slate-600 leading-relaxed">
                      The Courtyard Residence is located in a secured
                      access-controlled neighborhood. Provide your vehicle
                      details for automatic barrier clearance upon arrival.
                    </p>
                  </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                  <div className="flex flex-col gap-2">
                    ...
                    <input
                      className="px-4 py-3 bg-white rounded-xl text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-teal-900 shadow-sm placeholder:text-slate-400 border border-slate-200"
                      placeholder="e.g. KSF-492-AA"
                      type="text"
                    />
                  </div>
                  <div className="flex flex-col gap-2">
                    <label className="text-[10px] uppercase tracking-wider text-slate-500 font-bold">
                      Vehicle Model / Ride App
                    </label>
                    <input
                      className="px-4 py-3 bg-white rounded-xl text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-teal-900 shadow-sm placeholder:text-slate-400 border border-slate-200"
                      placeholder="e.g. Toyota Prado / Uber Black"
                      type="text"
                    />
                  </div>
                </div>
            ...
            <section className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 flex flex-col gap-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-xl text-slate-900 font-bold mb-1">
                    Curated Concierge Services
                  </h2>
                  <p className="text-sm text-slate-600">
                    Personalize your Ikoyi residence experience prior to
                    arrival.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-4">
                {/* Option 1 */}
                <label
                  className={`flex items-start gap-4 p-5 rounded-2xl transition-all cursor-pointer border ${addons.chauffeur ? "bg-teal-50 border-teal-200" : "bg-slate-50 border-slate-100 hover:bg-slate-100"}`}
                >
                  <input
                    className="mt-1 w-5 h-5 rounded accent-teal-900"
                    type="checkbox"
                    checked={addons.chauffeur}
                    onChange={() => toggleAddon("chauffeur")}
                  />
                  <div className="flex-1 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                    <div>
                      ...
                      <p className="text-sm text-slate-600">
                        Air-conditioned executive SUV with security-cleared
                        driver directly to Ikoyi villa.
                      </p>
                    </div>
                    <span className="text-base text-teal-900 font-bold whitespace-nowrap">
                      +₦35,000
                    </span>
                  </div>
                </label>
                ...
                {/* Option 2 */}
                <label
                  className={`flex items-start gap-4 p-5 rounded-2xl transition-all cursor-pointer border ${addons.chef ? "bg-teal-50 border-teal-200" : "bg-slate-50 border-slate-100 hover:bg-slate-100"}`}
                >
                  <input
                    className="mt-1 w-5 h-5 rounded accent-teal-900"
                    type="checkbox"
                    checked={addons.chef}
                    onChange={() => toggleAddon("chef")}
                  />
                  <div className="flex-1 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                    <div>
                      <div className="flex items-center gap-2 mb-1">
                        <span className="text-base text-slate-900 font-bold">
                          Dedicated In-Villa Private Chef
                        </span>
                        <span className="text-[10px] px-2 py-0.5 rounded-full bg-slate-200 text-slate-700 font-bold">
                          Chef Dayo
                        </span>
                      ...
                      <p className="text-sm text-slate-600">
                        Daily curated breakfasts & Nigerian/Continental dining
                ...
                {/* Option 3 */}
                <label
                  className={`flex items-start gap-4 p-5 rounded-2xl transition-all cursor-pointer border ${addons.cot ? "bg-teal-50 border-teal-200" : "bg-slate-50 border-slate-100 hover:bg-slate-100"}`}
                >
                  <input
                    className="mt-1 w-5 h-5 rounded accent-teal-900"
                    type="checkbox"
                    checked={addons.cot}
                    onChange={() => toggleAddon("cot")}
                  />
                  <div className="flex-1 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                    <div>
                      <div className="flex items-center gap-2 mb-1">
                        <span className="text-base text-slate-900 font-bold">
                          Sanitized Wooden Infant Cot
                        </span>
                      ...
                      <p className="text-sm text-slate-600">
                        Pre-assembled in the master bedroom with organic cotton
                        bedding.
                      </p>
                    </div>
                    <span className="text-base text-teal-900 font-bold whitespace-nowrap">
            ...
            <section className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 flex flex-col gap-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">
                    Protected by Central Bank of Nigeria compliant 256-bit
                    encryption escrow.
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-4 h-4 rounded-full flex items-center justify-center border-2 ${selectedPayment === "card" ? "border-teal-900" : "border-slate-300"}`}
                      >
                  ...
                  <div>
                    <p className="text-xs text-slate-500 mb-2">
                      Verve, Mastercard, Visa via Paystack/Flutterwave.
                    </p>
                    <div className="flex items-center gap-2">
                      <span className="text-[9px] uppercase font-bold tracking-wider px-2 py-0.5 rounded bg-white border border-slate-200 text-slate-700">
                        Verve
                      </span>
                      <span className="text-[9px] uppercase font-bold tracking-wider px-2 py-0.5 rounded bg-white border border-slate-200 text-slate-700">
                        Mastercard
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-4 h-4 rounded-full flex items-center justify-center border-2 ${selectedPayment === "transfer" ? "border-teal-900" : "border-slate-300"}`}
                      >
                  ...
                  <div>
                    <p className="text-xs text-slate-500 mb-2">
                      Automated instant payment verification via dynamic virtual
                      account.
                    </p>
                    <span className="text-[9px] uppercase font-bold tracking-wider px-2 py-0.5 rounded bg-orange-100 border border-orange-200 text-orange-800">
                      Zero card fail rate
                    </span>
                  </div>
                </div>
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-4 h-4 rounded-full flex items-center justify-center border-2 ${selectedPayment === "usd" ? "border-teal-900" : "border-slate-300"}`}
                      >
                        {selectedPayment === "usd" && (
                          <div className="w-2 h-2 rounded-full bg-teal-900" />
                        )}
                  ...
                  <div>
                    <p className="text-xs text-slate-500 mb-2">
                      Charge directly to AMEX, UK/US/EU cards at live CBN
                      interbank rate.
                    </p>
                    <span className="text-xs font-bold text-teal-900 mt-1 inline-block">
                      Estimated ~$1,050 USD
                    </span>
                  </div>
                </div>
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-4 h-4 rounded-full flex items-center justify-center border-2 ${selectedPayment === "ussd" ? "border-teal-900" : "border-slate-300"}`}
                      >
                  ...
                  <div>
                    <p className="text-xs text-slate-500 mb-2">
                      GTBank, Access, Zenith, UBA & First Bank instant mobile
                      string.
                    </p>
                    <span className="text-[10px] font-bold text-slate-600 mt-1 inline-block">
                      *737# • *901# • *966#
                    </span>
                  </div>
                </div>
                ...
                <div className="p-5 rounded-2xl bg-slate-50 border border-slate-100 flex flex-col gap-4 mt-2">
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="relative">
                      <input
                        className="w-full px-4 py-3 bg-white rounded-xl text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-teal-900 shadow-sm border border-slate-200"
                        placeholder="5399 •••• •••• 8201"
                        type="text"
                        defaultValue="5399 4120 9044 8201"
                      />
                      <CreditCard
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="flex flex-col gap-2">
                      ...
                      <input
                        className="px-4 py-3 bg-white rounded-xl text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-teal-900 shadow-sm border border-slate-200"
                        placeholder="MM/YY"
                        type="text"
                        defaultValue="08/27"
                      />
                  ...
                  <p className="text-xs text-slate-500 flex items-center gap-1.5 mt-2">
                    ...
                    Card details are tokenized by Paystack (PCIDSS Level 1
                    Certified). Monarch Stay does not store card data.
                  </p>
                </div>
              )}
            </section>
            ...
            <section className="p-6 rounded-2xl bg-slate-50 border border-slate-100 flex flex-col gap-4">
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                ...
                <strong className="text-slate-900">
                  48 hours before check-in (by 2:00 PM, Oct 22, 2025)
                </strong>{" "}
                for a full refund minus ₦10,000 processing charges. Caution
                escrow of ₦50,000 is automatically unfrozen and returned within
                24 hours post-checkout following standard housekeeper checklist
                sign-off.
              </p>
          ...
          <aside className="lg:col-span-5 sticky top-28 flex flex-col gap-8">
            <div className="bg-white rounded-2xl p-6 shadow-xl border border-slate-100 flex flex-col gap-6">
              ...
              <div className="flex gap-4 items-start pb-4 border-b border-slate-100">
                <div className="w-24 h-24 rounded-xl overflow-hidden shrink-0 shadow-sm relative">
                  <img
                    ...
                    height={96}
                  />
                  <span className="absolute bottom-1 right-1 bg-white/90 backdrop-blur-sm text-teal-900 text-[10px] px-1.5 py-0.5 rounded font-bold uppercase">
                    Ikoyi
                  </span>
                </div>
                <div className="flex flex-col min-w-0 flex-1">
                  <div className="flex items-center gap-1 text-orange-500 mb-1">
                    ...
                    <span className="text-xs text-slate-500 font-semibold">
                      (84 reviews) • Superhost
                    </span>
                  </div>
                  <h2 className="text-base text-slate-900 font-bold truncate">
                    The Courtyard Residence & Private Pool
                  </h2>
              ...
              <div className="flex flex-col gap-3 py-4 bg-slate-50 p-5 rounded-xl border border-slate-100">
                <h3 className="text-[10px] uppercase tracking-wider text-teal-900 font-bold mb-1">
                  Billing Breakdown
                </h3>
                <div className="flex justify-between items-center text-sm">
                  <span className="text-slate-600">
                    ₦{basePrice.toLocaleString()} × 5 nights
                  </span>
                ...
                <div className="flex justify-between items-center text-sm">
                  <div className="flex items-center gap-1 text-slate-600">
                    <span>Monarch Stay Concierge & Facility Fee</span>
                  </div>
                  <span className="text-slate-900 font-semibold">
                    ₦{fees.toLocaleString()}
                  </span>
                ...
                <div className="pt-4 mt-2 border-t border-slate-200 flex justify-between items-end">
                  <div>
                    <span className="text-base text-slate-900 block font-bold">
                      Total Payable
                    </span>
                  ...
                  <div className="text-right">
                    <span className="text-3xl text-teal-900 font-bold block">
                      ₦{grandTotal.toLocaleString()}
                    </span>
                    <span className="text-xs text-slate-500 font-semibold">
                      approx. ${(grandTotal / 805).toFixed(0)} USD
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-4 pt-2">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-[10px] uppercase tracking-wider text-slate-900 font-bold">
                      Zero Outage Guarantee
                    </h4>
                    <p className="text-xs text-slate-500 mt-1 leading-relaxed">
                      Dual soundproof 60kVA Perkins generators + 15kWh hybrid
                      lithium-solar inverter. Constant chilled AC.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-[10px] uppercase tracking-wider text-slate-900 font-bold">
                      CBN-Compliant Escrow Protection
                    </h4>
                    <p className="text-xs text-slate-500 mt-1 leading-relaxed">
                      Funds are secured safely in licensed custody until 24
                      hours after successful arrival and inspection.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between p-4 rounded-xl bg-slate-100 text-xs text-slate-600 border border-slate-200">
              ...
              <Link
                href="/support"
                className="font-bold text-teal-900 hover:text-orange-600 transition-colors"
              >
                Chat with Monarch Stay Concierge
              </Link>
            </div>
          </aside>
        </div>
