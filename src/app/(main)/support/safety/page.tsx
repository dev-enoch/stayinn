    ...
    <div className="w-full">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          At Monarch Stay, we are committed to creating a secure and trustworthy
          community for both guests and hosts. Here's how we protect you every
          step of the way.
        </p>
      </div>
              ...
              <li className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Every host and property goes through a rigorous verification
                    process to ensure authenticity and quality standards.
                  </p>
                </div>
              </li>
              <li className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Transactions are securely processed through our platform.
                    Never pay directly outside the Monarch Stay system.
                  </p>
                </div>
              </li>
            </ul>
          ...
          <div className="relative z-10 h-full flex flex-col justify-between">
            <div>
              ...
              <p className="text-gray-300 text-lg mb-4">
                We protect your home as if it were our own, with comprehensive
                coverage and vetting.
              </p>
            </div>

            <ul className="space-y-4 mt-8 border-t border-gray-800 pt-6">
              <li className="flex items-center gap-3 text-gray-200 font-medium">
                <CheckCircle2 size={20} className="text-green-400" /> Damage
                Protection
              </li>
              <li className="flex items-center gap-3 text-gray-200 font-medium">
                <CheckCircle2 size={20} className="text-green-400" /> Guest
                Screening
              </li>
            </ul>
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <p className="text-gray-600 max-w-xl text-lg">
                ...
                any urgent issues, ensuring peace of mind during every stay.
              </p>
            </div>
          </div>
          <Link
      ...
      <div className="bg-red-50 border border-red-100 rounded-2xl p-8 md:p-10 text-center max-w-3xl mx-auto mb-12 shadow-sm">
        ...
        <p className="text-gray-700 mb-8 text-lg">
          If you find yourself in immediate danger, please contact local
          authorities immediately before contacting Monarch Stay support.
        </p>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          ...
          <div className="bg-white px-6 py-4 rounded-xl border border-red-100 shadow-sm flex items-center justify-center gap-3">
            ...
            <span className="font-semibold text-gray-900 text-lg">
              Medical Emergency: <strong>112</strong>
            </span>
          </div>
        </div>
        <p className="text-sm text-red-600/80 mt-6 font-medium">
          112 is the toll-free national emergency number in Nigeria.
        </p>
      </div>
    </div>
  );
