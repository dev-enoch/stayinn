...
export default function SupportPage() {
  ...
  const handleTicketSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      alert(
        "Ticket submitted successfully! Our guest operations team will contact you shortly.",
      );
    }, 1500);
  };
  ...
  return (
    <div className="w-full bg-slate-50 font-sans text-slate-900 min-h-screen flex flex-col pt-5">
        ...
        <div className="relative z-10 max-w-[1280px] mx-auto px-4 md:px-12 py-20 flex flex-col items-center text-center w-full">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-md mb-6 text-teal-100 border border-white/20">
            ...
            <span className="text-xs uppercase tracking-wider font-bold">
              Monarch Stay Hospitality Assistance Hub
            </span>
          </div>
          ...
          <p className="text-lg md:text-xl text-teal-100 max-w-2xl mb-10 leading-relaxed">
            Instant answers to reservation queries, power supply assurances,
            estate security protocol, and payment procedures across our verified
            Nigerian stays.
          </p>
          ...
          <form
            ...
            className="w-full max-w-2xl bg-white rounded-2xl shadow-xl p-2 flex items-center gap-2 transition-all duration-300 focus-within:shadow-2xl focus-within:ring-4 focus-within:ring-teal-500/30"
          >
            ...
            <button
              type="submit"
              className="px-6 py-3 rounded-xl bg-teal-900 hover:bg-teal-800 text-white font-bold text-sm uppercase tracking-wider flex-shrink-0 transition-colors shadow-md"
            >
              Search
            </button>
          </form>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-slate-100 p-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-6">
            ...
            <div>
              <h2 className="text-lg text-slate-900 font-bold">
                Monarch Stay Real-Time Dispatch is Online
              </h2>
              <p className="text-slate-500 text-sm mt-1">
                Lagos, Abuja & Calabar concierge teams are active. Average
                response:{" "}
                <span className="font-bold text-teal-900">under 3 minutes</span>
                .
              </p>
            </div>
          </div>
          <div className="flex items-center gap-3 w-full md:w-auto justify-end">
            <a
              ...
              className="px-5 py-3 rounded-xl bg-slate-50 hover:bg-slate-100 border border-slate-200 text-teal-900 font-bold text-xs uppercase tracking-wider flex items-center gap-2 transition-colors"
            >
              <ShieldCheck size={18} /> Emergency Protocols
            </a>
            <a
              href="https://wa.me/2348130007829"
              target="_blank"
              rel="noopener noreferrer"
              className="px-5 py-3 rounded-xl bg-teal-900 text-white hover:bg-teal-800 font-bold text-xs uppercase tracking-wider flex items-center gap-2 transition-colors shadow-md"
            >
      ...
      <section className="max-w-[1280px] mx-auto w-full px-4 md:px-12 pt-20">
        <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-4 mb-10">
          <div>
            ...
            <h2 className="font-serif text-3xl md:text-4xl text-slate-900 font-bold tracking-tight mt-2">
              Browse by Category
            </h2>
          </div>
          <p className="text-slate-500 max-w-md text-lg">
            Comprehensive guides covering everything from arrival logistics in
            gated estates to dual-currency settlement.
          </p>
        </div>
        ...
        >
          ...
          <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm hover:shadow-xl hover:border-teal-100 transition-all flex flex-col justify-between group">
            <div>
              ...
              <h3 className="text-xl text-slate-900 font-bold mt-2 mb-3">
                Booking & Reservations
              </h3>
              <p className="text-slate-500 text-sm mb-6 leading-relaxed">
                Modifying dates, managing group itineraries, automated check-in
                codes, and booking extensions.
              </p>
              <ul className="flex flex-col gap-3 text-sm font-semibold text-slate-700">
                <li>
                  <Link
                    href="/support/article/self-check-in"
                    className="flex items-center justify-between hover:text-teal-900 transition-colors"
                  >
                    <span>Self check-in smart lock access</span>
                    <ChevronRight size={16} />
                  </Link>
                </li>
                <li>
                  <Link
                    href="/support/article/extensions"
                    className="flex items-center justify-between hover:text-teal-900 transition-colors"
                  >
                    <span>Itinerary changes & date extensions</span>
                    <ChevronRight size={16} />
                  </Link>
                </li>
                <li>
                  <Link
                    href="/support/article/group-stays"
                    className="flex items-center justify-between hover:text-teal-900 transition-colors"
                  >
                    <span>Group stays & ID verification</span>
                    <ChevronRight size={16} />
                  </Link>
                </li>
              </ul>
          ...
          <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm hover:shadow-xl hover:border-teal-100 transition-all flex flex-col justify-between group">
            <div>
              ...
              <h3 className="text-xl text-slate-900 font-bold mt-2 mb-3">
                Payments, VAT & Pricing
              </h3>
              <p className="text-slate-500 text-sm mb-6 leading-relaxed">
                Seamless payments via NGN Debit Cards, USSD, Bank Transfer, USD
                Cards, and caution deposit handling.
              </p>
              <ul className="flex flex-col gap-3 text-sm font-semibold text-slate-700">
                <li>
                  <Link
                    href="/support/article/refund-schedules"
                    className="flex items-center justify-between hover:text-teal-900 transition-colors"
                  >
                    <span>Refund schedules & timelines</span>
                    <ChevronRight size={16} />
                  </Link>
                </li>
                <li>
                  <Link
                    href="/support/article/caution-deposits"
                    className="flex items-center justify-between hover:text-teal-900 transition-colors"
                  >
                    <span>Caution deposit holds & release</span>
                    <ChevronRight size={16} />
                  </Link>
                </li>
                <li>
                  <Link
                    href="/support/article/tax-invoices"
                    className="flex items-center justify-between hover:text-teal-900 transition-colors"
                  >
                    <span>FIRS compliant tax invoices</span>
                    <ChevronRight size={16} />
                  </Link>
                </li>
              </ul>
          ...
          <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm hover:shadow-xl hover:border-teal-100 transition-all flex flex-col justify-between group">
            <div>
              ...
              <h3 className="text-xl text-slate-900 font-bold mt-2 mb-3">
                Stays & On-Site Amenities
              </h3>
              <p className="text-slate-500 text-sm mb-6 leading-relaxed">
                Solar and generator backup switch times, Enterprise Starlink &
                Fiber Wi-Fi, private chefs, and housekeeping.
              </p>
              <ul className="flex flex-col gap-3 text-sm font-semibold text-slate-700">
                <li>
                  <Link
                    href="/support/article/power-policies"
                    className="flex items-center justify-between hover:text-teal-900 transition-colors"
                  >
                    <span>Guaranteed 24/7 power policies</span>
                    <ChevronRight size={16} />
                  </Link>
                </li>
                <li>
                  <Link
                    href="/support/article/internet-resets"
                    className="flex items-center justify-between hover:text-teal-900 transition-colors"
                  >
                    <span>Fibre & satellite broadband resets</span>
                    <ChevronRight size={16} />
                  </Link>
                </li>
                <li>
                  <Link
                    href="/support/article/catering"
                    className="flex items-center justify-between hover:text-teal-900 transition-colors"
                  >
                    <span>In-villa catering & cleaning</span>
                    <ChevronRight size={16} />
                  </Link>
                </li>
              </ul>
          ...
          <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm hover:shadow-xl hover:border-teal-100 transition-all flex flex-col justify-between group">
            <div>
              ...
              <p className="text-slate-500 text-sm mb-6 leading-relaxed">
                Gated estate gate-pass generation, guest registrations, noise
                curfews, and verified host credentials.
              </p>
              <ul className="flex flex-col gap-3 text-sm font-semibold text-slate-700">
                <li>
                  <Link
                    href="/support/article/gate-codes"
                    className="flex items-center justify-between hover:text-teal-900 transition-colors"
                  >
                    <span>Generating estate gate codes</span>
                    <ChevronRight size={16} />
                  </Link>
                </li>
                <li>
                  <Link
                    href="/support/article/party-restrictions"
                    className="flex items-center justify-between hover:text-teal-900 transition-colors"
                  >
                    <span>Visitor limits & party restrictions</span>
                    <ChevronRight size={16} />
                  </Link>
                </li>
                <li>
                  <Link
                    href="/support/article/armed-escort"
                    className="flex items-center justify-between hover:text-teal-900 transition-colors"
                  >
                    <span>Armed escort & transit info</span>
                    <ChevronRight size={16} />
                  </Link>
                </li>
              </ul>
      ...
      <section className="max-w-[1280px] mx-auto w-full px-4 md:px-12 pt-20">
        <div className="bg-teal-50 rounded-[2.5rem] p-8 md:p-12 relative overflow-hidden flex flex-col lg:flex-row items-center justify-between gap-12 border border-teal-100 shadow-sm">
          <div className="flex-1 z-10">
            ...
            <h3 className="font-serif text-3xl md:text-4xl text-slate-900 font-bold mt-3 mb-4">
              The Monarch Stay Guarantee in Every City
            </h3>
            <p className="text-slate-600 max-w-xl mb-8 leading-relaxed text-lg">
              Every villa, loft, and penthouse listed undergoes physical
              verification by our Nigerian operations team. From uninterrupted
              dual-source power systems in Victoria Island to secure estate
              access in Abuja's Diplomatic Zone, we ensure standard luxury.
            </p>
            ...
            <div className="grid grid-cols-3 gap-4 max-w-md">
              <div className="bg-white p-4 rounded-2xl text-center shadow-sm border border-slate-100">
                <span className="font-serif text-2xl md:text-3xl text-teal-900 font-bold block">
                  99.8%
                </span>
                <span className="text-[10px] sm:text-xs text-slate-500 font-bold uppercase tracking-wider mt-1 block">
                  Power Uptime
                </span>
              </div>
              <div className="bg-white p-4 rounded-2xl text-center shadow-sm border border-slate-100">
              ...
              <div className="bg-white p-4 rounded-2xl text-center shadow-sm border border-slate-100">
                <span className="font-serif text-2xl md:text-3xl text-orange-600 font-bold block">
                  100%
                </span>
                <span className="text-[10px] sm:text-xs text-slate-500 font-bold uppercase tracking-wider mt-1 block">
                  Verified Stays
          ...
          <div className="relative flex-shrink-0 flex items-center justify-center w-full lg:w-96 h-80 bg-teal-900 rounded-[2rem] overflow-hidden p-8 text-white shadow-xl">
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              <p className="text-teal-100 text-sm mt-3 leading-relaxed">
                Available 24/7 across Lagos Island, Ikeja, Maitama, Jabi, and
      ...
      <section
        className="max-w-[1280px] mx-auto w-full px-4 md:px-12 pt-20"
            ...
            <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8 pb-10 border-b border-orange-500/50">
              <div>
                ...
                <h2 className="font-serif text-3xl md:text-4xl text-white font-bold tracking-tight">
                  Monarch Stay Rapid Response Network
                </h2>
                <p className="text-orange-100 max-w-xl mt-3 text-lg">
                  For urgent safety, maintenance, medical dispatch, or security
                  protocol escalations during your stay in Nigeria.
                </p>
              </div>
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full lg:w-auto">
                <a
                  href="tel:+2348130007829"
                  className="px-6 py-4 rounded-xl bg-white text-orange-700 hover:bg-orange-50 font-bold text-sm uppercase tracking-wider flex items-center justify-center gap-2 shadow-lg transition-colors"
                >
                  <Phone size={20} />
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-6 py-4 rounded-xl bg-orange-700 hover:bg-orange-800 text-white font-bold text-sm uppercase tracking-wider flex items-center justify-center gap-2 transition-colors border border-orange-500"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-10">
              <div className="bg-black/10 backdrop-blur-md rounded-2xl p-6 border border-white/10 hover:bg-black/20 transition-colors">
                ...
                <h4 className="text-xl text-white font-bold mb-2">
                  National 112 / 767 (Lagos)
                </h4>
                <p className="text-orange-100 text-sm leading-relaxed">
                  Direct connection to State Emergency Management (LASEMA) and
                  Federal Police command centers.
                </p>
              </div>
              ...
              <div className="bg-black/10 backdrop-blur-md rounded-2xl p-6 border border-white/10 hover:bg-black/20 transition-colors">
                <div className="flex items-center gap-2 text-orange-200 mb-3">
                  <Building2 size={24} />
                  <span className="text-xs uppercase tracking-wider font-bold">
                    Medical Partner Dispatch
                  </span>
                </div>
                <h4 className="text-xl text-white font-bold mb-2">
                  Private Ambulances On-Call
                </h4>
                <p className="text-orange-100 text-sm leading-relaxed">
                  Affiliated priority ambulance transport to Reddington, Lagoon,
                  or Nizamiye Hospital Abuja.
                </p>
              </div>
              ...
              <div className="bg-black/10 backdrop-blur-md rounded-2xl p-6 border border-white/10 hover:bg-black/20 transition-colors">
                <div className="flex items-center gap-2 text-orange-200 mb-3">
                  <Building size={24} />
                  <span className="text-xs uppercase tracking-wider font-bold">
                    Physical Security Intervention
                  </span>
                </div>
                <h4 className="text-xl text-white font-bold mb-2">
                  Estate Liaison Officers
                </h4>
                <p className="text-orange-100 text-sm leading-relaxed">
                  Dedicated field officers stationed in Lekki, Ikoyi, Ikeja GRA,
                  and Abuja Central for in-person support.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
          ...
          <div className="lg:col-span-7 bg-white rounded-3xl p-8 md:p-12 shadow-xl shadow-slate-200/50 border border-slate-100">
            <div className="mb-8 border-b border-slate-100 pb-8">
              ...
              <h3 className="font-serif text-3xl text-slate-900 font-bold mt-2">
                Submit a Support Request
              </h3>
              <p className="text-slate-500 mt-3 text-lg">
                Our guest operations department will review your reservation
                file and respond within 15 minutes.
              </p>
            </div>
            ...
            <form onSubmit={handleTicketSubmit} className="flex flex-col gap-8">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3.5 text-slate-900 focus:bg-white focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 focus:outline-none transition-all"
                    placeholder="Amara Kalu"
                    required
                    type="text"
                  />
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="relative">
                    <select
                      className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3.5 text-slate-900 focus:bg-white focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 focus:outline-none transition-all appearance-none"
                      required
                    >
                      <option value="power">
                        24/7 Power or Generator Maintenance
                      </option>
                      ...
                      <option value="payment">
                        Billing, NGN/USD Charges, Refund
                      </option>
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3.5 text-slate-900 focus:bg-white focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 focus:outline-none transition-all resize-y min-h-[140px]"
                  placeholder="Please provide details such as estate address, unit number, or specific assistance required..."
                  required
                  rows={4}
                ></textarea>
              </div>
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            <div className="bg-white border border-slate-200 rounded-3xl p-8 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-slate-600 text-sm mb-6 leading-relaxed">
                Need guidance on meeting the Monarch Stay 24/7 Power standard,
                syncing external booking calendars, or setting up NGN settlement
                bank accounts?
              </p>
              <div className="flex flex-col gap-3">
                <Link
                  href="/host"
                  className="p-4 rounded-xl bg-slate-50 hover:bg-slate-100 border border-slate-100 text-slate-900 flex items-center justify-between transition-colors shadow-sm group"
                >
                  <span className="text-sm font-bold">
                    Host Guarantee & ₦25M Cover
                  </span>
                  <ArrowRight
                    size={18}
                    className="text-teal-900 group-hover:translate-x-1 transition-transform"
                  />
                </Link>
                <Link
                  href="/host"
            ...
            <div className="bg-slate-900 rounded-3xl p-8 shadow-xl text-white">
              ...
              <div className="flex flex-col gap-4 text-sm font-semibold">
                <Link
                  href="/support/terms"
                  className="text-slate-300 hover:text-white transition-colors flex items-center justify-between py-2 border-b border-slate-700/50"
                >
            ...
            <div className="bg-teal-50 border border-teal-100 rounded-2xl p-6 text-slate-700">
              <div className="flex items-center gap-2 text-teal-900 font-bold mb-3">
                ...
                <span className="text-xs uppercase tracking-wider">
                  Monarch Stay Physical Centers
                </span>
              </div>
              <p className="text-sm leading-relaxed">
                <strong className="text-teal-900">Lagos Hub:</strong> Plot 14
                Admiralty Way, Lekki Phase 1, Lagos.
                <br />
                <br />
                <strong className="text-teal-900">Abuja Hub:</strong> 5th Floor,
