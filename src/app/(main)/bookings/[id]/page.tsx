...
export default async function BookingDetailPage(props: {
  ...
  const isFailed =
    searchParams.status === "failed" || booking.status === "CANCELLED";
  ...
  return (
    <div className="w-full min-h-screen bg-gray-50 pt-28 pb-32">
      <div className="max-w-[800px] mx-auto px-4 md:px-0">
        <Link
          href="/explore"
          className="inline-flex items-center text-gray-500 hover:text-green-600 font-medium mb-8 transition-colors"
        >
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100">
            <div className="text-center mb-10">
              ...
              <p className="text-gray-500 font-medium">
                Your stay at {booking.hotel.name} is all set.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="flex flex-col items-center justify-center bg-gray-50 rounded-3xl p-8 border border-gray-200">
                <p className="font-bold text-gray-900 mb-6 uppercase tracking-wider text-sm">
                  Your Digital Key
                </p>
              ...
              <div className="space-y-6">
                <h3 className="font-bold text-xl text-gray-900 border-b border-gray-100 pb-4">
                  Reservation Details
                </h3>
