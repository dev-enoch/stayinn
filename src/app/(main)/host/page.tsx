...
export const metadata: Metadata = {
  title: "List Your Property — Become a Monarch Stay Host",
  description:
    "Earn more from your serviced apartment. Join Monarch Stay's network of verified hosts across Lagos, Abuja and beyond. Transparent payouts, full-service management.",
  openGraph: {
    title: "Become a Monarch Stay Host",
    description:
      "Earn more from your serviced apartment in Nigeria. Transparent payouts, full-service management.",
    type: "website",
    url: "/host",
  },
};
...
export default async function HostPage() {
  let managerCount = 0;
  try {
    managerCount = await prisma.user.count({
  ...
  return (
    <div className="w-full bg-slate-50 font-sans text-slate-900 min-h-screen flex flex-col">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col gap-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-md w-fit border border-white/20">
                ...
                <span className="text-xs uppercase tracking-widest text-teal-100 font-bold">
                  Partner Portal & Host Yield Engine
                </span>
              </div>

              <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl leading-tight tracking-tight text-white font-bold">
                Turn Your Luxury Space into{" "}
                <span className="italic font-normal text-orange-400">
                  Exceptional Returns
                </span>
              </h1>
              ...
              <div className="pt-8 grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-4 border-t border-teal-800/50 mt-4">
                <div className="flex flex-col">
                  ...
                  <span className="text-xs text-teal-300 uppercase tracking-wider font-bold mt-1">
                    Management Fees
                  </span>
                </div>
                <div className="flex flex-col">
            ...
            <div className="lg:col-span-5 relative hidden lg:block">
              <div className="relative z-10 p-6 rounded-3xl bg-white text-slate-900 shadow-2xl border border-slate-100 transform rotate-1">
                ...
                <div className="mt-6 p-4 rounded-2xl bg-slate-50 flex flex-col gap-3 border border-slate-100">
                  ...
                  <svg
                    className="w-full h-12 text-teal-900"
                    fill="none"
                    preserveAspectRatio="none"
                    viewBox="0 0 300 40"
                  >
                    <path
                      d="M0 32 Q 50 28, 75 22 T 150 14 T 225 18 T 300 6"
                      fill="none"
                      stroke="currentColor"
                      strokeLinecap="round"
                      strokeWidth="3"
                    ></path>
                    <path
                      d="M0 32 Q 50 28, 75 22 T 150 14 T 225 18 T 300 6 L 300 40 L 0 40 Z"
                      fill="currentColor"
                      fillOpacity="0.1"
                    ></path>
                  </svg>
      ...
      <section
        className="w-full max-w-[1280px] mx-auto px-4 md:px-12 py-16 -mt-16 relative z-30"
        id="calculator"
      >
        <YieldEstimator />
      </section>
      ...
      <section className="w-full max-w-[1280px] mx-auto px-4 md:px-12 py-16">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <span className="text-xs uppercase tracking-widest text-teal-900 font-bold">
          ...
          <p className="text-slate-600 mt-4 leading-relaxed text-lg">
            We handle the complexities of high-end short stays so you enjoy
            passive, institutional-grade cash flow.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="group p-8 rounded-3xl bg-white border border-slate-100 hover:border-teal-100 transition-all duration-300 flex flex-col justify-between shadow-sm hover:shadow-xl hover:shadow-teal-900/5">
            <div className="flex flex-col gap-4">
              ...
              <p className="text-slate-600 leading-relaxed text-sm">
                Every prospective guest undergoes strict biometric BVN/NIN
                cross-checks, corporate email credentialing, and international
                passport validation before reservation approval.
              </p>
            </div>
          </div>
          ...
          <div className="group p-8 rounded-3xl bg-white border border-slate-100 hover:border-teal-100 transition-all duration-300 flex flex-col justify-between shadow-sm hover:shadow-xl hover:shadow-teal-900/5">
            <div className="flex flex-col gap-4">
              ...
              <span className="text-xs uppercase tracking-wider text-teal-900 font-bold">
                Turnkey Operations
              </span>
              <h3 className="text-xl text-slate-900 font-bold leading-tight">
              ...
              <p className="text-slate-600 leading-relaxed text-sm">
                Keyless smart-lock installation, professional 5-star linen
                turnover, dedicated emergency technicians, diesel fuel level
                tracking, and monthly preventative checks.
              </p>
            </div>
          </div>
          ...
          <div className="group p-8 rounded-3xl bg-white border border-slate-100 hover:border-teal-100 transition-all duration-300 flex flex-col justify-between shadow-sm hover:shadow-xl hover:shadow-teal-900/5">
            <div className="flex flex-col gap-4">
              ...
              <p className="text-slate-600 leading-relaxed text-sm">
                Rest easy with comprehensive primary coverage on high-value
                artworks, furnishings, and structural fittings. Direct automated
                deposits into your Nigerian or domiciliary bank.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-[1280px] mx-auto px-4 md:px-12">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
            ...
            <p className="text-teal-100 max-w-md text-lg leading-relaxed">
              From first submission to welcome cocktails for your first guest in
              under seven business days.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative">
            ...
            <div className="p-8 rounded-3xl bg-teal-900/50 border border-teal-800 flex flex-col justify-between hover:bg-teal-900 transition-colors">
              <div>
                <span className="font-serif text-5xl text-teal-700/50 font-bold">
                  01
                </span>
                <h3 className="text-xl font-bold mt-4 mb-3">Submit Details</h3>
                <p className="text-teal-100 text-sm leading-relaxed">
                  Provide basic property coordinates, room inventory, and
                  desired availability window via our fast web form.
                </p>
              </div>
            ...
            <div className="p-8 rounded-3xl bg-teal-900/50 border border-teal-800 flex flex-col justify-between hover:bg-teal-900 transition-colors">
              <div>
                ...
                <p className="text-teal-100 text-sm leading-relaxed">
                  Our engineering inspectors verify inverter/generator
                  redundancy, water pressure, internet latency, and safety
                  fixtures.
                </p>
              </div>
            ...
            <div className="p-8 rounded-3xl bg-teal-900/50 border border-teal-800 flex flex-col justify-between hover:bg-teal-900 transition-colors">
              <div>
                ...
                <p className="text-teal-100 text-sm leading-relaxed">
                  Professional architectural photography, 3D matterport
                  walkthrough capture, and boutique Nigerian art placement.
                </p>
              </div>
              <div className="mt-8 pt-4 border-t border-teal-800/50 flex items-center gap-2 text-orange-400 text-xs font-bold uppercase tracking-wider">
            ...
            <div className="p-8 rounded-3xl bg-teal-900/50 border border-teal-800 flex flex-col justify-between hover:bg-teal-900 transition-colors">
              <div>
                ...
                <p className="text-teal-100 text-sm leading-relaxed">
                  Listing goes live to verified corporate partners and
                  travelers. Automated payouts initiate upon first checkout.
                </p>
              </div>
              <div className="mt-8 pt-4 border-t border-teal-800/50 flex items-center gap-2 text-teal-300 text-xs font-bold uppercase tracking-wider">
      ...
      <section className="w-full max-w-[1280px] mx-auto px-4 md:px-12 py-20">
        <div className="p-8 md:p-16 rounded-[2.5rem] bg-orange-500 text-white shadow-2xl shadow-orange-500/20 relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="max-w-xl z-10 text-center md:text-left">
            <span className="text-xs uppercase tracking-widest text-orange-950 font-bold bg-orange-400/50 px-4 py-2 rounded-full inline-block mb-4">
            ...
            <p className="text-orange-50 text-lg mt-4 leading-relaxed">
              Partner with Nigeria's most trusted hospitality curator. Our
              onboarding team is available across Lagos, Abuja, and Port
              Harcourt.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 z-10 w-full md:w-auto">
            <a
              href="#calculator"
              className="w-full sm:w-auto h-14 px-8 rounded-xl bg-white text-orange-600 hover:bg-orange-50 font-bold flex items-center justify-center gap-2 shadow-xl transition-all"
            >
            ...
            <a
              ...
              className="w-full sm:w-auto h-14 px-8 rounded-xl bg-orange-600/50 hover:bg-orange-600 border border-orange-400 text-white font-bold flex items-center justify-center gap-2 transition-all backdrop-blur-sm"
            >
              <Phone size={20} />
