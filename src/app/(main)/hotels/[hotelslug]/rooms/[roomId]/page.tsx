...
export async function generateMetadata(props: {
  ...
  const description = room.description
    ...
    : `${room.name} — ${priceStr}/night at ${room.hotel.name}, ${room.hotel.address}. Book on Monarch Stay.`;
    ...
    <div className="w-full min-h-screen bg-white pb-32">
      ...
      <div className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-md border-b border-gray-100">
        <div className="max-w-[1280px] mx-auto px-4 md:px-12 h-20 flex items-center">
          <Link
            ...
            className="flex items-center text-gray-900 hover:text-green-600 font-semibold transition-colors"
          >
        ...
        <div className="mt-12 space-y-10 px-2 md:px-0">
          ...
          <div className="prose prose-lg text-gray-600 max-w-none">
            ...
            <p className="leading-relaxed text-lg">
              {room.description ||
                "Experience comfort and tranquility in our carefully designed spaces. This room features premium bedding, modern amenities, and everything you need for a perfect stay. Whether you are traveling for business or leisure, our attention to detail ensures a restful and rejuvenating experience."}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="fixed bottom-0 left-0 w-full bg-white border-t border-gray-100 p-4 md:p-6 z-50 shadow-[0_-10px_40px_rgba(0,0,0,0.03)]">
        <div className="max-w-[800px] mx-auto flex items-center justify-between">
          <div>
            <span className="block text-2xl md:text-3xl font-bold tracking-tight text-gray-900">
              {formattedPrice}
            </span>
