      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8">
        <div className="flex items-center justify-between mb-8 pb-6 border-b border-slate-100">
          <div>
            ...
            <p className="text-slate-500 mt-1">Manage your identity and contact details</p>
          </div>
          <button 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col gap-1">
            <span className="text-xs font-bold text-slate-500 uppercase tracking-wider">Legal Name</span>
            <div className="flex items-center gap-2">
              <span className="text-lg font-semibold text-slate-900">{user.fullName}</span>
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-lg font-medium text-slate-900">{user.email}</span>
            </div>
            <span className="text-xs text-slate-400">Primary contact for bookings</span>
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-lg font-medium text-slate-900">{user.phone ? `+234 ${user.phone}` : 'Not provided'}</span>
            </div>
            <span className="text-xs text-slate-400">Used for gate clearance</span>
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center gap-2">
              <span className="inline-flex px-3 py-1 bg-slate-100 rounded-md text-sm font-semibold text-slate-700">
                {user.role === 'HOTEL_MANAGER' ? 'Host' : user.role === 'ADMIN' ? 'Admin' : 'Guest'}
              </span>
            </div>
          </div>
        </div>
