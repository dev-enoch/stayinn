  ...
  return (
    <div className="w-full bg-white">
        ...
        <div className="flex flex-col md:flex-row items-end justify-between gap-12">
          ...
          <div className="md:w-1/3 pb-2">
            <p className="text-xl text-gray-600 leading-relaxed font-medium">
              We exist to bridge the gap between world-class standards and the
              rich, vibrant experiences our cities have to offer.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-32 px-4 md:px-12 max-w-[1280px] mx-auto">
        <div className="flex flex-col md:flex-row gap-20">
          ...
          <div className="md:w-2/3 space-y-8 text-xl text-gray-600 leading-relaxed">
            <p>
              Monarch Stay was born out of a simple belief: finding a beautiful,
              safe, and comfortable place to stay in Nigeria shouldn't be a
              gamble. For too long, travelers have had to choose between
              overpriced hotels and unpredictable short-term rentals.
            </p>
            <p>
              Whether you're traveling for business in Lagos, unwinding in
              Abuja, or exploring new horizons across the continent, we ensure
              every property listed on our platform meets strict criteria for
      ...
      <section className="py-24 px-4 md:px-12 max-w-[1280px] mx-auto border-t border-gray-100">
        <h2 className="text-5xl md:text-6xl font-bold tracking-tighter text-gray-900 mb-24">
          The Monarch Stay Standard.
        </h2>
        ...
        <div className="space-y-32">
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-16 group">
            <div className="w-full md:w-1/2 space-y-6">
              ...
              <p className="text-xl text-gray-600 leading-relaxed max-w-lg">
                We celebrate Nigerian culture. Our spaces don't just put a roof
                over your head; they connect you to the rhythm of the city,
                empowering local hosts to share their world.
              </p>
            </div>
            <div className="w-full md:w-1/2 aspect-[4/3] relative overflow-hidden">
              <Image
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-16">
          <div className="md:w-1/3">
            ...
            <p className="text-lg text-gray-600">
              Our community is growing every day, bringing premium experiences
              to more travelers.
            </p>
          </div>
