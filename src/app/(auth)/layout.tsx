    ...
    <div className="flex min-h-screen w-full bg-slate-50 overflow-hidden font-sans text-slate-900">
      ...
      <div className="hidden lg:flex flex-col lg:w-1/2 relative bg-white border-r border-slate-200 p-12 xl:p-20 justify-between">
        ...
        <div className="z-10 flex items-center">
          <Link
            href="/"
            className="text-3xl font-bold font-serif text-green-600 tracking-tight flex items-center"
          >
            Monarch Stay.
          </Link>
        </div>
        ...
        <div className="relative flex-1 w-full flex items-end justify-center mt-12 pointer-events-none">
          <svg
            className="w-full h-auto max-w-[450px] text-green-600/10"
            viewBox="0 0 400 300"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
              d="M200 300L400 200V100L200 200L0 100V200L200 300Z"
              fill="currentColor"
              fillOpacity="0.8"
            />
            <path
              d="M200 200L400 100L200 0L0 100L200 200Z"
              fill="currentColor"
              fillOpacity="0.4"
            />
