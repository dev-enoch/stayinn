  ...
  return (
    <div className="flex flex-col w-full text-slate-700">
      ...
      <form action={formAction} className="space-y-4">
        ...
        <label className="flex items-start gap-3 pt-2 group cursor-pointer">
          <input
            ...
            required
            name="consent"
            className="mt-1 min-w-[20px] min-h-[20px] accent-green-600 rounded cursor-pointer"
          />
          <span className="text-xs text-slate-500 leading-relaxed">
            ...
            , and consent to the processing of my data in accordance with NDPR.
          </span>
        </label>
      ...
      <div className="mt-8 text-center text-sm text-slate-500">
        ...
        <Link
          href="/login"
          className="text-green-600 font-medium hover:text-green-700 transition-colors min-h-[44px] inline-flex items-center"
        >
          Log in
        </Link>
      </div>
